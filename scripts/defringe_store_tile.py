...
bg_thresh muss die GESAMTE Antialiasing-Uebergangszone zwischen Hintergrund
und Motiv abdecken, nicht nur "nah am Hintergrund". Bei T-20260820-729932431
war der Uebergang am Rand der abgerundeten Ecke nur 1 Pixel breit, aber mit
einer Farbdistanz von ~97 zum Hintergrund -- ein zu kleiner bg_thresh (60)
liess genau dieses Pixel unverarbeitet (voll opak, urspruengliche helle
...
def defringe(path, out_path, bg=None, bg_thresh=150):
